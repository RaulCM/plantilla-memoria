...
\begin{itemize}
	...
	\item \textbf{/list}: Devuelve una tabla con la información de todas las Pull-Requests/Merge-Requests que se han llevado a cabo y permite filtrar por el estado de las mismas (abierta, cerrada o aceptada).
	...
	\item \textbf{/guide}: Contiene un resumen sobre la aplicación, una breve guía de uso definiendo cada una de las páginas y una tabla con los errores detectados por Pylint que son corregibles por la aplicación. 
	Llama a la vista \textit{views.guide}.
	\item \textbf{/contact}: Muestra los datos de contacto para informar de algún posible problema en la aplicación.
...
Para llevar a cabo el despliegue de la aplicación en Heroku es necesaria la configuración de dos ficheros
