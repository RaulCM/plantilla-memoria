...
\begin{enumerate}
  ...
  \item \textbf{Servicios y Aplicaciones Telemáticas}: Asignatura base para el desarrollo de este proyecto. En ella se tiene el primer contacto con Python, HTML, CSS y Django, tecnologías en las que se basa la aplicación desarrollada.
  \item \textbf{Ingeniería de Sistemas de Información}: Presenta el uso de las bases de datos y el lenguaje SQL y el despliegue de aplicaciones en Heroku.
